...
const { generateQuads, serializeQuads, annotateByOriginAndMetadata } = require('../lib/index');
...
async function claimImport(triggerNotification, metadataNotification, param) {
    ...
    // Add some quads from the original notification
    quads = await annotateByOriginAndMetadata(quads,triggerNotification,metadataNotification);
...
module.exports = { internalImport , claimImport , knownEvent };